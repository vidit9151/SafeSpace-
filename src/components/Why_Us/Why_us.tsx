...
const Why_us = () => {
  return (
    <div className="glass  mt-2 mx-2 text-center px-4 pb-4 ">
      <h1 className="text-2xl md:text-4xl pt-7 pb-4  ">Why Us ?</h1>
      <div className=" px-5 pt-[2rem] bg-white pb-6 shadow-inner shadow-black flex flex-col  ">
        <div className="grid grid-cols-4 md:grid-cols-4 justify-between pt-6 pb-8">
        ...
        <hr />
        <div className="px-10 py-5 bg-blue-300 pb-6 shadow-inner shadow-black">
